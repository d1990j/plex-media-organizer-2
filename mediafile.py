class Movie:
    def __init__(self, file_name: str, new_name: str | None = None, year: str | None = None):
        self.new_name = new_name
        self.year = year
        self.file_name = file_name
        self.staged = False

    def get_plex_folder_name(self) -> str:
        """Return the name of the file folder using the Plex naming convention."""
...
class TV:
    def __init__(self, file_name: str, new_name: str | None = None, year: str | None = None, season: str | None = None, episode: str | None = None):
        self.new_name = new_name
        self.year = year
        self.season = season
